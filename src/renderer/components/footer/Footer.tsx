    ...
    <footer>
      ...
      <div className="foot-links">
        ...
        <div className="social-links">
          <a href="https://discord.gg/invite/mutantetherbabies"><img className="discord" src={Discord}/></a>
        </div>
        <div className="social-links">
          <a href="https://twitter.com/mebnft"><img className="twitter" src={Twitter}/></a>
        </div>
        {/* <div className="social-links">
        ...
        <div className="social-links">
          <a href="mutantetherbabies@gmail.com"><img className="envelop" src={Envelop}/></a>
        </div>
      </div>
    </footer>
  );
