  ...
  return (
    <>
     ...
     <div className="game-title">
        <p><div style={{color: '#e63462'}}>Welcome to the Mutant Ether Babies Gaming and Metaverse section.</div></p>
        ...
        <p>Stay Tuned And Be Informed - Join The Next Level NFT Team.</p>
     </div>
    <div
      className="metaverse"
    >
